Arena5 = function (game) {
 ...
 /******************************************************************************************** */
    ...
    params = {"trigger":400,"normalCubesProbability":900,"downCubesProbability":1000,"downCubeSpeed":0.3,"downCubeTriggerX":5,"downCubeTriggerY":5,"pattern":[0,1],"minWidth":2,"maxWidth":0}
    scene.mapEngine.addParamsConfiguration(params)
    params = {"trigger":2000,"normalCubesProbability":80,"downCubesProbability":1000,"pattern":[0],"minWidth":1,"change":0,"maxWidth":0}
    scene.mapEngine.addParamsConfiguration(params)
    params = {"trigger":3000,"normalCubesProbability":700,"downCubesProbability":1000,"pattern":[-1,0,1,2],"minWidth":3,"maxWidth":4,"change":0}
    scene.mapEngine.addParamsConfiguration(params)
    params = {"trigger":4500,"normalCubesProbability":1000,"pattern":[-2,-1,0,1,2],"minWidth":2,"maxWidth":3,"change":0}
    scene.mapEngine.addParamsConfiguration(params)
    params = {"trigger":5000,"normalCubesProbability":0,"downCubesProbability":0,"pattern":[0],"minWidth":1,"maxWidth":0,"change":0}
    scene.mapEngine.addParamsConfiguration(params)
