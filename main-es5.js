...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      ...
      providers: [],
      bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _profil_profil_component__WEBPACK_IMPORTED_MODULE_8__["ProfilComponent"], _navbar_navbar_component__WEBPACK_IMPORTED_MODULE_6__["NavbarComponent"], _formation_formation_component__WEBPACK_IMPORTED_MODULE_7__["FormationComponent"], _projet_projet_component__WEBPACK_IMPORTED_MODULE_9__["ProjetComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_14__["FooterComponent"]],
    ...
    function () {
      ...
      _createClass(BlogService, [{
        ...
        value: function getAllFormations() {
          return this.http.get(this.baseURL + '/formations.JSON', {
        ...
        value: function getAllProjets() {
          return this.http.get(this.baseURL + '/projets.JSON', {
            headers: this.httpHeaders
          });
        }
      }, {
        ...
        value: function getAllCompetences() {
          return this.http.get(this.baseURL + '/competences.JSON', {
            headers: this.httpHeaders
          });
        }
      }]);
