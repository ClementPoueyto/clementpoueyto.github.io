Arena5 = function (game) {
 ...
 /******************************************************************************************** */
    ...
    scene.mapEngine.addParamsConfiguration(params)
    params = {"trigger":3000,"normalCubesProbability":600,"downCubesProbability":1000,"downCubeSpeed":0.3,"downCubeTriggerX":5,"downCubeTriggerY":5,"pattern":[-2,-1,0,1,2],"minWidth":3,"maxWidth":2,"change":0}
    scene.mapEngine.addParamsConfiguration(params)
