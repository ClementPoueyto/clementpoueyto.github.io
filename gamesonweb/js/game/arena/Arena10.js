Arena10 = function (game) {
 ...
 /** DECOR************************************************* */
    ...
    params = {"trigger":400,"normalCubesProbability":800,"jumpCubesProbability":1000,"pattern":[-1,0,1,2],"minWidth":2,"maxWidth":0,"change":50}
    scene.mapEngine.addParamsConfiguration(params)
    params = {"trigger":2000,"normalCubesProbability":800,"upCubesProbability":850,"upCubeSpeed":0.2,"upCubeTriggerX":5,"downCubesProbability":900,"downCubeSpeed":0.2,"downCubeTriggerX":5,"downCubeTriggerY":5,"pattern":[-2,-1,0,1,2],"minWidth":3,"maxWidth":2,"change":50}
    scene.mapEngine.addParamsConfiguration(params)
