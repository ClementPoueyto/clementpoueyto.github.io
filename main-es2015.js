...
let BlogService = class BlogService {
    ...
    getAllFormations() {
        return this.http.get(this.baseURL + '/formations/', { headers: this.httpHeaders });
    }
    getAllProjets() {
        return this.http.get(this.baseURL + '/projets/', { headers: this.httpHeaders });
    }
    getAllCompetences() {
        return this.http.get(this.baseURL + '/competences/', { headers: this.httpHeaders });
    }
};
